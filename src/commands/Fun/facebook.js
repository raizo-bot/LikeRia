...
message.channel.send("Please wait")
    ...
    let image = await AmeAPI.generate("discordhouse", { url: avatar, house: 'Balance'});
    let attachment = new Discord.MessageAttachment(image, "discordhouse.png");
