...
module.exports = class TestCommand extends BaseCommand {
  constructor() {
    super({
      name: "add",
      description: "To add user to the ticket channel",
      usage: "[p]add <user>",
      category: "Tickets",
      aliases: [],
  ...
  let embed3 = new Discord.MessageEmbed()
    .setColor("#cf1919")    .setFooter(`${message.author.username}`, message.author.avatarURL({dynamic:true}))   .setDescription(`Make sure to mention or type user's id next time!`)
